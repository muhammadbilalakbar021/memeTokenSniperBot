...
export type ShitTokenDocument = ShitTokenEntity & Document & { _id?: any };

@Schema({ timestamps: true })
export class ShitTokenEntity {
  _id?: any;
...
export const ShitTokenSchema = SchemaFactory.createForClass(ShitTokenEntity);
